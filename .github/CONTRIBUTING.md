...
2. **Ensure your fork is up-to-date**
    ...
    Once you've added an "upstream" remote pointing to [https://github.com/allenai/python-package-temlate.git](https://github.com/yieldlang/yieldlang), keeping your fork up-to-date is easy:
...
4. **Test your changes**
    ...
    And finally, please update the [CHANGELOG](https://github.com/yieldlang/yieldlang/blob/main/CHANGELOG.md) with notes on your contribution in the "Unreleased" section at the top.
